...
public class ItBcInOutboundServiceController {
  ...
  public ResponseEntity<?> exportInboundDataToExcel(
    @RequestBody PabeanFilter filter
  ) {
    try {
      String base64Data = itBcInOutboundService.exportInboundDataToExcel(
        filter
      );
  ...
  public ResponseEntity<?> exportOutboundDataToExcel(
    @RequestBody PabeanFilter filter
  ) {
    try {
      String base64Data = itBcInOutboundService.exportOutboundDataToExcel(
        filter
      );
