...
public class UserManagementServiceImpl implements UserManagementService {
    ...
    @Override
    public List<UserResponse> getAllUsers(String authorizationHeader, String xAuthToken) {
    ...
    private Long getCurrentUserId(String authorizationHeader, String xAuthToken) {
        ...
        throw new BusinessException(HttpStatus.UNAUTHORIZED, "User not authenticated");
    }

    private String extractAuthToken(String authorizationHeader, String xAuthToken) {
    ...
    private boolean hasRoleMaster(Long userId) {
        ...
        return roles.stream().anyMatch(role -> "MASTER".equalsIgnoreCase(role.getRoleCode()));
    }   
    ...
    private void validateRoleCodes(List<String> roleCodes) {
        for (String roleCode : roleCodes) {
            ...
            if (role == null) {
                throw new BusinessException(HttpStatus.BAD_REQUEST, "Role not found: " + roleCode);
            }
        }
    }
